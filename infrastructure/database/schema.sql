...
-- Create partitions for 2026 (full year coverage)
...
CREATE TABLE posts_2026_10 PARTITION OF posts
    FOR VALUES FROM ('2026-10-01') TO ('2026-11-01');

CREATE TABLE posts_2026_11 PARTITION OF posts
    FOR VALUES FROM ('2026-11-01') TO ('2026-12-01');

CREATE TABLE posts_2026_12 PARTITION OF posts
    FOR VALUES FROM ('2026-12-01') TO ('2027-01-01');

-- Safety net partition: catches any date outside the monthly partitions above
-- (e.g. posts older than 2026, or future months not yet partitioned).
-- Inserting into a partitioned table without a matching partition fails with
-- "no partition of relation posts found for row" - this default prevents that.
