...
export class KeywordsController {
  ...
  @ApiResponse({ status: 201, description: 'Keyword created successfully', type: KeywordResponseDto })
  @ApiResponse({ status: 409, description: 'Keyword already exists' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin only' })
  async create(@Body() createKeywordDto: CreateKeywordDto): Promise<KeywordResponseDto> {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  async findAll(@Query() query: GetKeywordsQueryDto): Promise<PaginatedKeywordsResponseDto> {
  ...
  @ApiResponse({ status: 200, description: 'Keyword retrieved successfully', type: KeywordResponseDto })
  ...
  @ApiResponse({ status: 200, description: 'Keyword updated successfully', type: KeywordResponseDto })
  @ApiResponse({ status: 404, description: 'Keyword not found' })
  @ApiResponse({ status: 409, description: 'Keyword already exists' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin only' })
  ...
  @ApiResponse({ status: 200, description: 'Keyword status toggled successfully', type: KeywordResponseDto })
  @ApiResponse({ status: 404, description: 'Keyword not found' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Admin only' })
